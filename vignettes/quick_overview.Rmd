...
In order to make this Vignette lighter, the workflow is run here on a random subset of 500 orthogroups. The example dataset are available in the exdata folder.
