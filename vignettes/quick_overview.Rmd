...
In the expression set every column represents one RNAseq sample. Now you might want to load in R also a table of metadata that describes the **experimental condition** under which every sample was harvested.
