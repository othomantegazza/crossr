...
# Load transcript quantification and metadata into R
...
## Load quantifications from other mapping algorithms
...
Now you might want to load into R also a table of metadata that describes the **experimental condition** under which every RNAseq sample was harvested. 
