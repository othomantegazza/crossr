...
In order to get rudimentary functional annotation for the orthogroups we simply associate to an orthogroup all the functional annotations of the genes composing it.
...
og_set@og_annos <- data.frame(vapply(og_set@og, get_annos, character(1)))

head(og_set@og_annos)
```

Afterward, as always, we can check for consistency of the og_set element.
