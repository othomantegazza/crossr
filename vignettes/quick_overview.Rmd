...
Orthofinder requires the proteomes of the species under study in order to infer orthogroups. In this example we downloaded the proteomes sequences from [NCBI](ftp://ftp.ncbi.nlm.nih.gov/genomes/) 
